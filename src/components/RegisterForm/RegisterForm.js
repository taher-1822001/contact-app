            ...
            <form onSubmit={this.registerFormHandler}>
              <div className="form-group row justify-content-center">
                ...
                <center>
                  ...
                  <div style={{ width: '200px', height: '200px', borderRadius: '50%', cursor: "pointer", border: "4px solid yellow" }}>
                  ...
                  <button onClick={this.handleRemoveImage} className="btn btn-danger mt-2 mb-5">
